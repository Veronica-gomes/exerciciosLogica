...
function exer06(){
    let base = parseInt(prompt("Informe o tamanho da Base"));
    let altura = parseInt(prompt("Informe o a altura"));
...
function exer07(){
    ...
    let resultado = dia + (ano * 365) + (mes * 30);
    alert (`Você possui ${resultado} dias de vida!`)
}
...
function exer08(){
    ...
    totalNulo = (nulos * 100) / eleitores
    totalValido = (nulos * 100) / eleitores

    alert(`O total de eleitores foi: ${eleitores} \nOs votos brancos foram: ${totalBranco}% \nOs votos nulos foram: ${totalNulo}% \nOs votos validos foram: ${totalValido}%`)
}

function exer09(){
    let salarioAtual = parseInt(prompt("Informe seu salario atual: "))
    let Reajuste = parseInt(prompt("Informe o percentual de reajuste: "))
    let ajuste, novoSalario = undefined;

    ajuste = (salarioAtual / 100) * Reajuste
    novoSalario = salarioAtual + ajuste

    alert(`Seu novo salario será de: R$${novoSalario.toFixed(2)}`)
}
...
function exer10(){
    ...
    alert(`O valor final é de: ${calcConsulmidor}`)
...
function exer12(){
    let far = parseInt(prompt("Digite a temperatura em Fahrenheit: "));
    let celsius = 5 * (far - 32) / 9

    alert(`${far} Fahrenheit em celsius é: ${celsius}°`)
}

function exer13(){
    let n1 = parseInt(prompt("Digite a primeira nota: "));
    let n2 = parseInt(prompt("Digite a segudna nota: "));
    let n3 = parseInt(prompt("Digite a terceira: "));
...
function exer22(){
    ...
    let salarioFinal, qtdHoraExtra, ganhoExtra = undefined;
...
function exer35(){
    let tipo = prompt("Escolha o combustível: [A]-Álcool | [G]-Gasolina: ").toUpperCase();
    let litros = parseInt(prompt("Quantidade em litros abastecida: "));
    let total = null;
    
    if (tipo == "A"){
        if(litros <= 20){
            total = 2.9 * (litros - (litros * 3/100));
            alert(`O valor com desconto será: R$${total.toFixed(2)}`);

        }else{
            total = 2.9 * (litros - (litros * 5/100));
            alert(`O valor com desconto será: R$${total.toFixed(2)}`);
        }
    }
    ...
    if (tipo == "G"){
        if(litros <= 20){
            total = 3.3 * (litros - (litros * 4/100));
            alert(`O valor com desconto será: R$${total.toFixed(2)}`);

        }else{
            total = 3.3 * (litros - (litros * 6/100));
            alert(`O valor com desconto será: R$${total.toFixed(2)}`);
        }
    }  
}
...
function exer40(){
    ...
    if (Quantidade > 5 && qtdComprada <= 10){
